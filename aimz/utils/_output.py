...
class _WriteStrategy(Protocol):
    ...
    batch while every other axis is written whole: ``axis=1`` streams the observation
    axis (data-parallel), ``axis=0`` streams the draw axis (draw-parallel).
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            axis: The streamed axis to grow (default ``1``, the observation axis).
        """
...
class _SliceWriteStrategy(_WriteStrategy):
    ...
    :exc:`NotImplementedError` on the first batch. With ``axis=1`` it streams the
    observation axis (data-parallel); with ``axis=0`` the draw axis (draw-parallel),
    where every site matches by construction.
    """
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            batch_size: Chunk length along the streamed axis.
            axis: The streamed axis to fill (default ``1``, the observation axis).
        """
        self._zarr_group = zarr_group
        self._total = total
