"""Benchmark wall-clock time for aimz `predict`."""
...
def main() -> None:
    """Benchmark aimz `predict` wall-clock time."""
    parser = argparse.ArgumentParser(description="Benchmark aimz predict runtime.")
    ...
    im.predict(loader, output_dir=args.output_dir, progress=False)
